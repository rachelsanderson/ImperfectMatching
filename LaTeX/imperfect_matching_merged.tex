...
\blfootnote{This project received funding from the NIH (Grant 1 R01 HD077227-01).}
...
% To fix ideas, suppose we observe an individual
...
% \textquotedblleft Joseph B. Smith\textquotedblright . 
